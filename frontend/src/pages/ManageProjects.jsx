...
function ManageProjects() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-10">
      <h1 className="text-5xl font-bold">Manage Projects</h1>
          ...
          >
            ...
            <div className="p-6">
              ...
              <button
                ...
                className="px-5 mt-6 py-3 rounded-full bg-blue-600 hover:bg-blue-700 transition">
                Edit
              </button>

              <button
                onClick={() => deleteProject(project.id)}
                className="mt-6 px-5 py-3 ml-4 rounded-full bg-red-600 hover:bg-red-700 transition"
              >
                Delete
              </button>
            </div>
